...
namespace JHSchool.Evaluation.Ranking
{
    ...
    {
        private Dictionary<string, JHStudentRecord> _studentDict;
        ...
        public RankDataCollector(List<JHStudentRecord> students, Rank ranker)
        {
            _studentDict = new Dictionary<string, JHStudentRecord>();
        ...
        public void Perform()
        {
            ...
            foreach (RankData data in _rankData)
            {
                if (RankType == RankType.Class)
                {
                    ...
                    {
                        JHStudentRecord student = _studentDict[id];
                    ...
                    all.Name = data.Name;
                    if (data.Tag != null) all.Tag = data.Tag;
                ...
                else if (RankType == RankType.GradeYear)
                {
                    ...
                    foreach (string id in data.Keys)
                    {
                        ...
                        if (student.Class != null)
                            gradeYear = "" + student.Class.GradeYear;
