...
namespace KaoHsiung.StudentExamScoreReport
{
    ...
    public static class Program
    {
        ...
        public static void Main()
        {
            ...
            detail.Add(new ReportFeature("KaoHsiung.JHEvaluation.Student.Report0002", "個人評量成績單"));
            ...
            {
                mb.Enable = (K12.Presentation.NLDPanels.Student.SelectedSource.Count > 0) && Framework.User.Acl["KaoHsiung.JHEvaluation.Student.Report0002"].Executable;
            ...
            {
                mb2.Enable = (K12.Presentation.NLDPanels.Class.SelectedSource.Count > 0) && Framework.User.Acl["KaoHsiung.JHEvaluation.Student.Report0002"].Executable;
                //mb.Enable = (JHSchool.Student.Instance.SelectedKeys.Count > 0);
            };
        }
    }
