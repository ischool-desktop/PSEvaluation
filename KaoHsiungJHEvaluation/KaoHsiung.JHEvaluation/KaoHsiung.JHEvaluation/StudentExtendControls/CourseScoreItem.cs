...
using KaoHsiung.JHEvaluation.StudentExtendControls.CourseScoreItemControls;
using KaoHsiung.JHEvaluation.Utility;

namespace KaoHsiung.JHEvaluation.StudentExtendControls
{
