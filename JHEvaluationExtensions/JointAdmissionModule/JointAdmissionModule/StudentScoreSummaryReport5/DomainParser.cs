    ...
    internal class DomainParser : Campus.Rating.IScoreParser<ReportStudent>
    {
        ...
        public decimal? GetScore(ReportStudent student)
        {
           // SemesterScore score = null;
            ...
            //    SemesterData sd = new SemesterData(each.GradeYear, each.SchoolYear, each.Semester);

              
            //        if (student.SemestersScore[sd].Domain.Contains(_DomainName))
            //        {
            //            if (student.SemestersScore[sd].Domain[_DomainName].Value.HasValue)
            //                SumScore += student.SemestersScore[sd].Domain[_DomainName].Value.Value;                        
            //        }            
            //}
