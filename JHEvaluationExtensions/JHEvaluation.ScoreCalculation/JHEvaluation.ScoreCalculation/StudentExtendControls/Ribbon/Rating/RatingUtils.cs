    ...
    internal static class RatingUtils
    {
        ...
        public static void SetExamDefaultItems(ComboBoxEx ctlExam)
        {
            try
            {
                ...
                List<JHExamRecord> exams = Data.JHExam.SelectAll();
        ...
        public static List<ScoreParser> ToScoreParsers(this IEnumerable<string> subjects, string token)
        {
        ...
        public static List<MultiScoreParser> ToMultiScoreParsers(this IEnumerable<string> subjects, List<string> tokens)
        {
